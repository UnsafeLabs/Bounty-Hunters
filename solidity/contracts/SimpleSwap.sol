...
contract SimpleSwap {
    ...
    // FIXED: minAmountOut + deadline parameters added for slippage protection
    // FIXED: Fee calculation uses proper fixed-point math (Uniswap V2 style)
    function swap(address tokenIn, uint256 amountIn, uint256 minAmountOut, uint256 deadline) external returns (uint256 amountOut) {
        ...
        // constant product formula with proper fixed-point fee math
