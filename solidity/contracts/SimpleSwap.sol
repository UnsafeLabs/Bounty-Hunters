...
contract SimpleSwap {
    ...
    uint256 public constant MIN_FEE = 1; // minimum fee of 1 unit to prevent zero-fee
    ...
    function swap(address tokenIn, uint256 amountIn, uint256 minAmountOut, uint256 deadline) external returns (uint256 amountOut) {
        ...
        // Fee calculation with proper rounding to prevent zero-fee for small amounts
        uint256 feeAmount = (amountIn * fee + FEE_PRECISION - 1) / FEE_PRECISION;
