...
contract YieldVault {
    ...
    // FIX #914: Cap at periodFinish to prevent phantom rewards after period ends
    ...
    // FIX #914: Uses capped rewardPerToken from above
    ...
    // FIX #914: Access control — only rewardDistributor can call
    // FIX #914: Precision loss — rewardRate uses 1e18 multiplier
