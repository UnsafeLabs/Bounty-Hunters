...
contract YieldVault {
    ...
    function rewardPerToken() public view returns (uint256) {
        ...
        uint256 effectiveTime = block.timestamp < periodFinish ? block.timestamp - lastUpdateTime : periodFinish - lastUpdateTime;
        return rewardPerTokenStored + (
            effectiveTime * rewardRate * 1e18 / totalSupply
        );
    }
