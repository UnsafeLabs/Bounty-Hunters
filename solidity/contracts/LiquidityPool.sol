...
contract LiquidityPool is ERC20 {
    ...
    // FIX: MINIMUM_LIQUIDITY is now actually enforced — lock to address(0) on first deposit
    ...
    function removeLiquidity(uint256 lpTokens) external returns (uint256 amountA, uint256 amountB) {
        ...
        // FIX: Use reserveA/reserveB not balanceOf — direct transfers can't inflate withdrawal
