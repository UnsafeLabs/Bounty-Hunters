...
contract LiquidityPool is ERC20 {
    ...
    function addLiquidity(
        ...
        if (totalSupply() == 0) {
            ...
            uint256 lpFromA = amountA * currentTotalSupply / reserveA;
            uint256 lpFromB = amountB * currentTotalSupply / reserveB;
    ...
    function removeLiquidity(
        ...
        uint256 currentTotalSupply = totalSupply();
        amountA = lpTokens * reserveA / currentTotalSupply;
        amountB = lpTokens * reserveB / currentTotalSupply;
