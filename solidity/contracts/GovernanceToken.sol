...
contract GovernanceToken is ERC20, Ownable {
    ...
    // FIXED: Uses msg.sender instead of tx.origin — prevents phishing vulnerability
    ...
    // FIXED: Same tx.origin issue — now uses msg.sender
    ...
    // FIXED: Uses msg.sender == owner() instead of tx.origin for admin check
