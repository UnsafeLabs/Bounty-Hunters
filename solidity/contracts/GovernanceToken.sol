...
contract GovernanceToken is ERC20 {
    ...
    /// @dev Fix: Uses msg.sender instead of tx.origin to prevent phishing attacks
    ...
    /// @dev Fix: Uses msg.sender instead of tx.origin
    ...
    /// @notice Take a snapshot of current balances
    /// @dev Fix: Uses msg.sender instead of tx.origin for admin check
