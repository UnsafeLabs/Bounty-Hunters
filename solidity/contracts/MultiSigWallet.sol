 ...
 * @dev OpenZeppelin-style reentrancy guard. Prevents reentrant calls to
 *      functions marked with the `nonReentrant` modifier.
 */
...
contract MultiSigWallet is ReentrancyGuard {
    ...
    /// @notice Execute a confirmed transaction. Protected against reentrancy
    ///         by the nonReentrant modifier and the executed flag check.
    ///         State changes (setting executed=true) occur before the external
    ///         call, following the Checks-Effects-Interactions pattern.
