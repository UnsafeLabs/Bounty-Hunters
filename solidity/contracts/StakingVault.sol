...
contract StakingVault is ReentrancyGuard {
    ...
    // State updates moved BEFORE external call to prevent reentrancy
    ...
    // FIX: Same pattern applied to claimRewards
    // State update before external call + nonReentrant modifier
