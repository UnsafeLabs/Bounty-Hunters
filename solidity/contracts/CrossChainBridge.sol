...
contract CrossChainBridge {
    ...
    bytes32 public constant TRANSFER_TYPEHASH = keccak256(
        "BridgeTransfer(address sender,address recipient,uint256 amount,uint256 nonce,uint256 chainId,address verifyingContract)"
    );
    ...
    function processTransfer(
        ...
        _processTransfer(recipient, recipient, amount, transferNonce, signature);
    }
    ...
    function processTransfer(
        ...
        _processTransfer(sender, recipient, amount, transferNonce, signature);
    }
    ...
    function _processTransfer(
        ...
        bytes32 transferHash = transferDigest(sender, recipient, amount, transferNonce);
