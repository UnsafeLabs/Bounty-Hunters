...
contract CrossChainBridge is ReentrancyGuard {
    ...
    constructor(address _bridgeToken, address _validator) {
        ...
        // EIP-712 domain separator with chainId and verifyingContract for replay protection
    ...
    function processTransfer(
        address recipient, uint256 amount, uint256 transferNonce,
        uint256 sourceChainId, bytes calldata signature
    ) external nonReentrant {
        bytes32 transferHash = keccak256(abi.encodePacked(
            recipient, amount, transferNonce, sourceChainId, block.chainid, address(this)
        ));
     ...
     * Uses the domain separator to ensure cross-chain and post-upgrade replay protection.
     */
    ...
    /**
     * @dev Returns the EIP-712 digest for a transfer, for off-chain signing.
     */
