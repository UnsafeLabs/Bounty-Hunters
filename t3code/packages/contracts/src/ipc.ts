...
import type { PeerDiagnostics, TailscaleDiagnosePeerInput } from "./tailscale.ts";
import type {
...
export interface LocalApi {
  ...
  server: {
    ...
    diagnoseTailscalePeer: (input: TailscaleDiagnosePeerInput) => Promise<PeerDiagnostics>;
  };
}
