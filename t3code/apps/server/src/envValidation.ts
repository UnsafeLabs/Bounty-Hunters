...
interface ServerEnvSpec {
  readonly name: keyof ServerEnvShape & string;
...
export const ServerEnvSpecs: ReadonlyArray<ServerEnvSpec> = [
  ...
  },
  {
    ...
    kind: "string",
    sensitive: true,
    defaultValue: "bundled telemetry project key",
    expected: "non-empty string",
  ...
  },
  {
    ...
    expected: "absolute URL",
    description: "Telemetry ingestion host.",
  },
  {
...
export const validateServerEnv = (
  ...
  const decoded = decodeServerEnv(env);
