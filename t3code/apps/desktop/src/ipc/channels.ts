...
export const BACKEND_CONNECTION_STATE_CHANNEL = "desktop:backend-connection-state";
export const GET_BACKEND_CONNECTION_STATE_CHANNEL = "desktop:get-backend-connection-state";
