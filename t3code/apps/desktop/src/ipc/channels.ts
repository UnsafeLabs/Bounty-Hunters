...
export const UPDATE_DEFER_CHANNEL = "desktop:update-defer";
export const UPDATE_SKIP_VERSION_CHANNEL = "desktop:update-skip-version";
export const UPDATE_GET_RELEASE_NOTES_CHANNEL = "desktop:update-get-release-notes";
