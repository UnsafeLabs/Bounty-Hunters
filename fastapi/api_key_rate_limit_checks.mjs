...
includes(tests, 'test_missing_key_can_be_optional', 'tests should cover optional missing keys');
includes(tests, 'test_invalid_rate_limit_configuration_is_rejected', 'tests should cover invalid rate-limit configuration');
includes(tests, 'test_request_store_handles_concurrent_access_safely', 'tests should cover concurrent store access');
