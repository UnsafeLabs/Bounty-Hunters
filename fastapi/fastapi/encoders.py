...
def _encode_bytes(obj: bytes, encoding: str = "base64") -> str:
    """Encode bytes to a JSON-compatible string.

    Args:
        obj: The bytes object to encode.
        encoding: The encoding method - "base64" (default) or "hex".

    Returns:
        A base64 or hex encoded string.
    """
    if encoding == "hex":
        return obj.hex()
    # Default to base64
...
def jsonable_encoder(
    ...
    bytes_encoding: Annotated[
        ...
        Doc(
            """
            Encoding method for bytes objects. Defaults to "base64".
            Can be set to "hex" for hexadecimal encoding.
            """
        ),
    ] = "base64",
) -> Any:
    ...
    if isinstance(obj, memoryview):
        return _encode_bytes(bytes(obj), encoding=bytes_encoding)
