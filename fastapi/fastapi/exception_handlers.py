...
def _redact_sensitive(body: dict | list | str | int | float | bool | None) -> dict | list | str | int | float | bool | None:
    """Recursively redact sensitive fields from a parsed JSON body."""
