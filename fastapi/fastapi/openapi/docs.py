...
def get_swagger_ui_html(
    *,
    ...
    <link type="text/css" rel="stylesheet" href="{current_swagger_css_url}">
    ...
    <script src="{current_swagger_js_url}"></script>
...
def get_redoc_html(
    *,
    ...
    <script src="{current_redoc_js_url}"> </script>
    </body>
    </html>
    """
    return HTMLResponse(html)
