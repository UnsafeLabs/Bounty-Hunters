      ...
      *================================================================
       ...
       01  WS-SUBJECT-DN-FULL          PIC X(256).
       ...
       1000-INITIALIZE.
           ...
           MOVE SPACES TO WS-SUBJECT-DN-FULL
       ...
       2000-VALIDATE-CERT-CHAIN.
           ...
           PERFORM VARYING WS-CHAIN-INDEX FROM 1 BY 1
               ...
               END-READ
               IF WS-CHAIN-INDEX = 1
                   MOVE CS-SUBJECT-DN TO WS-SUBJECT-DN-FULL
               END-IF
       ...
       3500-PARSE-SUBJECT-DN.
           ...
           PERFORM VARYING WS-RDN-INDEX FROM 1 BY 1
               ...
               IF WS-RDN-ENTRY(WS-RDN-INDEX)(1:4) = ' CN='
                   MOVE WS-RDN-ENTRY(WS-RDN-INDEX)(5:64)
                       TO WS-PARSED-CN
               END-IF
           END-PERFORM
           IF WS-PARSED-CN(1:1) = '"'
