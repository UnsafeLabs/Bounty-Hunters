      ...
      *================================================================
       ...
       01  WS-AUDIT-LAST-POS           PIC S9(4) VALUE 0.
       ...
       8100-APPEND-AUDIT-FIELD.
           COMPUTE WS-AUDIT-FIELD-LENGTH =
               FUNCTION LENGTH(FUNCTION TRIM(WS-AUDIT-FIELD TRAILING))
           COMPUTE WS-AUDIT-LAST-POS =
               WS-AUDIT-PTR + WS-AUDIT-FIELD-LENGTH - 1
           IF WS-AUDIT-PTR > WS-AUDIT-DATA-LIMIT
               PERFORM 8200-MARK-AUDIT-TRUNCATED
           ELSE
               IF WS-AUDIT-LAST-POS > WS-AUDIT-DATA-LIMIT
                   PERFORM 8200-MARK-AUDIT-TRUNCATED
               ELSE
