...
includes(tests, 'test_download_streams_file_with_content_type', 'tests should cover download response headers');
includes(tests, 'test_delete_removes_file_thumbnail_and_record', 'tests should cover delete cleanup');
includes(tests, 'test_image_upload_generates_thumbnail_when_gd_is_available', 'tests should cover image thumbnail generation');
includes(tests, "markTestSkipped('GD is not available", 'thumbnail test should skip cleanly without GD');
