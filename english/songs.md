...
[When the code compiles clean
And the tests all pass green
We raise up our screens
To the debug routines: write 2 more chorus lines — must maintain the "internet/heartbreak" metaphor, rhyme scheme AABB]
...
And the tests all pass green
We raise up our screens
To the debug routines: write 2 more verse lines — continue the theme of digital loneliness, rhyme with each other]

**[Bridge]**
[When the code compiles clean
And the tests all pass green
We raise up our screens
To the debug routines: write 4-line bridge — shift tone to acceptance, slower rhythm, can break rhyme scheme]
...
And the tests all pass green
We raise up our screens
To the debug routines: write 3 more chorus lines — must be upbeat and absurd, reference different extinct species, maintain polka rhythm]
...
And the tests all pass green
We raise up our screens
To the debug routines: write 2 more verse lines — rhyme with each other, reference the dodo's obliviousness]

**[Verse 3]**
[When the code compiles clean
And the tests all pass green
We raise up our screens
To the debug routines: write full 4-line verse — pick another extinct animal (mammoth, saber-tooth, etc.), maintain humorous polka tone, AABB rhyme]
...
And the tests all pass green
We raise up our screens
To the debug routines: write full 4-line verse — continue the "computer science lullaby" theme, reference threads/deadlocks/race conditions in a soothing way, AABB rhyme]
...
And the tests all pass green
We raise up our screens
To the debug routines: write 2 closing lines — wrap up the lullaby, reference shutdown/sleep mode, rhyme with each other]
